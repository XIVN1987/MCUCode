...
void USART_DeInit(USART_TypeDef *USARTx)
{
    ...
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART5, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART5, DISABLE);
    }
    else if(USARTx == USART6)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART6, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART6, DISABLE);
    }
    else if(USARTx == USART7)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART7, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART7, DISABLE);
    }
    else if(USARTx == USART8)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART8, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART8, DISABLE);
    }
    else if(USARTx == USART9)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART9, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART9, DISABLE);
    }
    else if(USARTx == USART10)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART10, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_USART10, DISABLE);
    }
}
