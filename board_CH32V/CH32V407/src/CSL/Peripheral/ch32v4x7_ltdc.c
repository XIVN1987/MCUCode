...
{
    RCC_HBPeriphResetCmd(RCC_HBPeriph_LTDC, ENABLE);
    RCC_HBPeriphResetCmd(RCC_HBPeriph_LTDC, DISABLE);
}
 ...
 *        one of the following values: LTDC_Layer1    
...
void LTDC_LayerInit(LTDC_Layer_TypeDef* LTDC_Layerx, LTDC_Layer_InitTypeDef* LTDC_Layer_InitStruct)
{
    ...
    LTDC_Layerx->DCCR &= ~(LTDC_DCCR_DCBLUE | LTDC_DCCR_DCGREEN | LTDC_DCCR_DCRED );
