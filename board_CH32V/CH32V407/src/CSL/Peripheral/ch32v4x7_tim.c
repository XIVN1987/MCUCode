...
void TIM_DeInit(TIM_TypeDef *TIMx)
{
    ...
    {
        RCC_PB2PeriphResetCmd(RCC_PB2Periph_TIM8, ENABLE);
        RCC_PB2PeriphResetCmd(RCC_PB2Periph_TIM8, DISABLE);
    }
    else if(TIMx == TIM2)
    {
    ...
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM5, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM5, DISABLE);
    }
    else if(TIMx == TIM6)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM6, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM6, DISABLE);
    }
    else if(TIMx == TIM7)
    {
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM7, ENABLE);
        RCC_PB1PeriphResetCmd(RCC_PB1Periph_TIM7, DISABLE);
    }
}
 ...
 *            TIM6/TIM7 only have TIM_IT_Update.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 *
 * @param   TIMx - where x can be 1 to 8 to general Event.
 *          TIM_EventSource 
 ...
 *            TIM_EventSource_COM - TIM Commutation Event.
 *            TIM_EventSource_Trigger - TIM Trigger Event.
 *            TIM_EventSource_Break - TIM Break Event.
 *            TIM6/TIM7 only have TIM_EventSource_Update.
 * @return  none
 */
 ...
 *            TIM6/TIM7 only have TIM_DMA_Update
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 *
 * @param   TIMx - where x can be （1 2 3 4 5 8） select the TIM peripheral.
 ...
 *
 * @param   TIMx - where x can be （1 8） select the TIM peripheral.
 *          TIM_Channel - specifies the TIM Channel.
 *            TIM_Channel_1 - TIM Channel 1.
 *            TIM_Channel_2 - TIM Channel 2.
 *            TIM_Channel_3 - TIM Channel 3.
 ...
 *
 * @param   TIMx - where x can be 1 to 8 select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
 ...
 *
 * @brief   Enables or disables the Both edge capture of the TIMx Channel2.
 *
 * @param   TIMx - where x can be (1,2,3,4,5,8)  to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 ...
 *
 * @brief   Enables or disables the Both edge capture of the TIMx Channel3.
 *
 * @param   TIMx - where x can be (1,2,3,4,5,8)  to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 ...
 *
 * @brief   Enables or disables the Both edge capture of the TIMx Channel4.
 *
 * @param   TIMx - where x (1,2,3,4,5,8) to select the TIM peripheral.
 *          NewState - ENABLE or DISABLE.
 *
 * @return  none
 */
