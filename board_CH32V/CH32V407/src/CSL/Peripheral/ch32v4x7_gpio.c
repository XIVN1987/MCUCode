 ...
 *            GPIO_Remap_SPI3 - SPI3 Alternate Function mapping
 ...
 *            GPIO_Remap_TIM5CH4_LSI_LSI connected to TIM5 Channel4 input capture for calibration
 ...
 *            GPIO_Remap_PTP_PPS - PTP_PPS Alternate Function mapping
 *            GPIO_Remap_ETHPHY_LED - ETHPHY_LED Alternate Function mapping
 *            GPIO_Remap_TIM8 - TIM8 Alternate Function mapping
 *            GPIO_Remap_FSMC - FSMC Alternate Function mapping
 *            GPIO_Remap_FSMC_NADV - FSMC NADV Alternate Function mapping
 *            GPIO_Remap_LTDC - LTDC Alternate Function mapping
 *            GPIO_Remap_SDIO - SDIO Alternate Function mapping
 *            GPIO_Remap_DVP - DVP Alternate Function mapping
 *            GPIO_Remap_I3C - I3C Alternate Function mapping
 ...
 *            GPIO_PartialRemap_USART9 - USART9 Partial Alternate Function mapping
 *            GPIO_FullRemap_USART9 - USART9 Full Alternate Function mapping
 *            GPIO_PartialRemap_USART10 - USART10 Partial Alternate Function mapping
 *            GPIO_FullRemap_USART10 - USART10 Full Alternate Function mapping
 *
...
void GPIO_PinRemapConfig(uint32_t GPIO_Remap, FunctionalState NewState)
{
    ...
    else if((GPIO_Remap & 0x40000000) == 0x40000000)
    {
        tmp = AFIO->PCFR2;
        tmp1 = AFIO->PCFR1;
    }
    ...
    if((GPIO_Remap & 0x40000000) != 0x40000000)
    {
    ...
    if(NewState != DISABLE)
    {
        if((GPIO_Remap & 0x40000000) == 0x40000000)
        {
            tmp |= ((GPIO_Remap & 0x2) << 26);
            tmp1 |= ((GPIO_Remap & 0x1) << 2);;           
        }
        else
        {
            tmpreg |= (tmp << (((GPIO_Remap & 0x7FFFFFFF)>> 0x15) * 0x10));
