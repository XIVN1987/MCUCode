...
#define DMA1_Channel9_IT_Mask     ((uint32_t)(DMA_GIF9 | DMA_TCIF9 | DMA_HTIF9 | DMA_TEIF9))
#define DMA1_Channel10_IT_Mask    ((uint32_t)(DMA_GIF10 | DMA_TCIF10 | DMA_HTIF10 | DMA_TEIF10))
#define DMA1_Channel11_IT_Mask    ((uint32_t)(DMA_GIF11 | DMA_TCIF11 | DMA_HTIF11 | DMA_TEIF11))
#define DMA1_Channel12_IT_Mask    ((uint32_t)(DMA_GIF12 | DMA_TCIF12 | DMA_HTIF12 | DMA_TEIF12))
#define DMA1_Channel13_IT_Mask    ((uint32_t)(DMA_GIF13 | DMA_TCIF13 | DMA_HTIF13 | DMA_TEIF13))
...
#define DMA1_EXTEN_FLAG_Mask        ((uint32_t)0x40000000)
 ...
 *        1 to 13 for DMA1 and 1 to 11 for DMA2 to select the DMA Channel.
 *
 * @return  none
 */
void DMA_DeInit(DMA_Channel_TypeDef *DMAy_Channelx)
{
    ...
    else if(DMAy_Channelx == DMA1_Channel9)
    {
        DMA1->INTFCR |= DMA1_Channel9_IT_Mask;
    }
    else if(DMAy_Channelx == DMA1_Channel10)
    {
        DMA1->INTFCR |= DMA1_Channel10_IT_Mask;
    }
    else if(DMAy_Channelx == DMA1_Channel11)
    {
        DMA1->INTFCR |= DMA1_Channel11_IT_Mask;
    }
    else if(DMAy_Channelx == DMA1_Channel12)
    {
        DMA1->INTFCR |= DMA1_Channel12_IT_Mask;
    }
    else if(DMAy_Channelx == DMA1_Channel13)
    {
        DMA1->INTFCR |= DMA1_Channel13_IT_Mask;
    }
 ...
 *            DMA1_FLAG_GL9 - DMA1 Channel9 global flag.
 *            DMA1_FLAG_TC9 - DMA1 Channel9 transfer complete flag.
 *            DMA1_FLAG_HT9 - DMA1 Channel9 half transfer flag.
 *            DMA1_FLAG_TE9 - DMA1 Channel9 transfer error flag.
 *            DMA1_FLAG_GL10 - DMA1 Channel10 global flag.
 *            DMA1_FLAG_TC10 - DMA1 Channel10 transfer complete flag.
 *            DMA1_FLAG_HT10 - DMA1 Channel10 half transfer flag.
 *            DMA1_FLAG_TE10 - DMA1 Channel10 transfer error flag.
 *            DMA1_FLAG_GL11 - DMA1 Channel11 global flag.
 *            DMA1_FLAG_TC11 - DMA1 Channel11 transfer complete flag.
 *            DMA1_FLAG_HT11 - DMA1 Channel11 half transfer flag.
 *            DMA1_FLAG_TE11 - DMA1 Channel11 transfer error flag.
 *            DMA1_FLAG_GL12 - DMA1 Channel12 global flag.
 *            DMA1_FLAG_TC12 - DMA1 Channel12 transfer complete flag.
 *            DMA1_FLAG_HT12 - DMA1 Channel12 half transfer flag.
 *            DMA1_FLAG_TE12 - DMA1 Channel12 transfer error flag.
 *            DMA1_FLAG_GL13 - DMA1 Channel13 global flag.
 *            DMA1_FLAG_TC13 - DMA1 Channel13 transfer complete flag.
 *            DMA1_FLAG_HT13 - DMA1 Channel13 half transfer flag.
 *            DMA1_FLAG_TE13 - DMA1 Channel13 transfer error flag.
...
FlagStatus DMA_GetFlagStatus(uint32_t DMAy_FLAG)
{
    ...
    else if((DMAy_FLAG & DMA1_EXTEN_FLAG_Mask) == DMA1_EXTEN_FLAG_Mask)
    {
        tmpreg = DMA1_EXTEN->INTFR;
    }
    else 
    {
        tmpreg = DMA1->INTFR;
 ...
 *            DMA1_IT_GL9 - DMA1 Channel9 global flag.
 *            DMA1_IT_TC9 - DMA1 Channel9 transfer complete flag.
 *            DMA1_IT_HT9 - DMA1 Channel9 half transfer flag.
 *            DMA1_IT_TE9 - DMA1 Channel9 transfer error flag.
 *            DMA1_IT_GL10 - DMA1 Channel10 global flag.
 *            DMA1_IT_TC10 - DMA1 Channel10 transfer complete flag.
 *            DMA1_IT_HT10 - DMA1 Channel10 half transfer flag.
 *            DMA1_IT_TE10 - DMA1 Channel10 transfer error flag.
 *            DMA1_IT_GL11 - DMA1 Channel11 global flag.
 *            DMA1_IT_TC11 - DMA1 Channel11 transfer complete flag.
 *            DMA1_IT_HT11 - DMA1 Channel11 half transfer flag.
 *            DMA1_IT_TE11 - DMA1 Channel11 transfer error flag.
 *            DMA1_IT_GL12 - DMA1 Channel12 global flag.
 *            DMA1_IT_TC12 - DMA1 Channel12 transfer complete flag.
 *            DMA1_IT_HT12 - DMA1 Channel12 half transfer flag.
 *            DMA1_IT_TE12 - DMA1 Channel12 transfer error flag.
 *            DMA1_IT_GL13 - DMA1 Channel13 global flag.
 *            DMA1_IT_TC13 - DMA1 Channel13 transfer complete flag.
 *            DMA1_IT_HT13 - DMA1 Channel13 half transfer flag.
 *            DMA1_IT_TE13 - DMA1 Channel13 transfer error flag. 
...
ITStatus DMA_GetITStatus(uint32_t DMAy_IT)
{
   ITStatus bitstatus = RESET;
    ...
    else if((DMAy_IT & DMA1_EXTEN_FLAG_Mask) == DMA1_EXTEN_FLAG_Mask)
    {
        tmpreg = DMA1_EXTEN->INTFR;
    }
    else 
