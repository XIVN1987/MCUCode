...
*******************************************************************************/
#ifndef __CH32V4x7_LTDC_H
#define __CH32V4x7_LTDC_H
...
LTDC_PosTypeDef *LTDC_GetPosStatus(LTDC_PosTypeDef *LTDC_Pos_InitStruct);
void LTDC_PosStructInit(LTDC_PosTypeDef* LTDC_Pos_Struct);
