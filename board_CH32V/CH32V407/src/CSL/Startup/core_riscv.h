...
extern uint32_t __get_VXRM(void);
extern void __set_VXRM(uint32_t value);
extern uint32_t __get_VXSAT(void);
extern void __set_VXSAT(uint32_t value);
extern uint32_t __get_VCSR(void);
extern void __set_VCSR(uint32_t value);
extern uint32_t __get_VL(void);
extern uint32_t __get_VTYPE(void);
extern uint32_t __get_VLENB(void);
